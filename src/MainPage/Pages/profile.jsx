...
import {  Avatar_02 } from "../../imagepath"
              ...
              <div className="profile-header">
                <div className="row align-items-center">
                  <div className="col-auto profile-image">
                    <a href="#">
                      <img className="rounded-circle" alt="User Image" src={Avatar_02} />
                    </a>
                  </div>
                      ...
                      <div className="card">
                        <div className="card-body">
                          <h5 className="card-title d-flex justify-content-between">
                            ...
                            <a className="edit-link" href="#"><i className="fa fa-edit mr-1" /> Edit</a>
                          </h5>
                          <button className="btn btn-success" type="button"><i className="fe fe-check-verified" /> Active</button>
                        </div>
                      </div>
                      {/* /Account Status */}
                      {/* Skills */}
