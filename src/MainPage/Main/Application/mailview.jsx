...
import {PlaceHolder,Avatar_02} from '../../../imagepath';
                    ...
                    <div className="mailview-header">
                      <div className="row">
                        <div className="col-sm-8 col-md-7 col-lg-9">
                          <div className="text-truncate m-b-10">
                            <span className="mail-view-title">Innovative Conference Schedule</span>
                          </div>
                        </div>
                      ...
                      <div className="sender-info">
                        <div className="sender-img">
                          <img width={40} alt="User Image" src={Avatar_02} className="rounded-circle" />
                        </div>
                  ...
                  <div className="mailview-footer">
                    <div className="row">
                      <div className="col-sm-6 left-action">
                        <button type="button" className="btn btn-white mr-1"><i className="fa fa-reply" /> Reply</button>
                        <button type="button" className="btn btn-white"><i className="fa fa-share" /> Forward</button>
                      </div>
                      <div className="col-sm-6 right-action">
                        <button type="button" className="btn btn-white mr-1"><i className="fa fa-print" /> Print</button>
